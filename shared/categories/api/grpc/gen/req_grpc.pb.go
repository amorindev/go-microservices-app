...
const (
	CategoryService_Create_FullMethodName = "/categoriesPB.CategoryService/Create"
	CategoryService_GetAll_FullMethodName = "/categoriesPB.CategoryService/GetAll"
)
...
type CategoryServiceClient interface {
	Create(ctx context.Context, in *CreateCategoryReq, opts ...grpc.CallOption) (*Category, error)
	GetAll(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*GetAllResp, error)
}
...
func (c *categoryServiceClient) Create(ctx context.Context, in *CreateCategoryReq, opts ...grpc.CallOption) (*Category, error) {
...
func (c *categoryServiceClient) GetAll(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*GetAllResp, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GetAllResp)
...
type CategoryServiceServer interface {
	Create(context.Context, *CreateCategoryReq) (*Category, error)
	GetAll(context.Context, *emptypb.Empty) (*GetAllResp, error)
...
func (UnimplementedCategoryServiceServer) Create(context.Context, *CreateCategoryReq) (*Category, error) {
	return nil, status.Error(codes.Unimplemented, "method Create not implemented")
}
func (UnimplementedCategoryServiceServer) GetAll(context.Context, *emptypb.Empty) (*GetAllResp, error) {
...
func _CategoryService_Create_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CategoryServiceServer).Create(ctx, req.(*CreateCategoryReq))
	}
...
var CategoryService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "categoriesPB.CategoryService",
