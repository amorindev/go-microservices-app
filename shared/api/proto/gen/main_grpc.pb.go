...
const (
	OrderService_Create_FullMethodName = "/ordersPB.OrderService/Create"
)
...
type OrderServiceClient interface {
	Create(ctx context.Context, in *CreateOrderReq, opts ...grpc.CallOption) (*Order, error)
}
...
func (c *orderServiceClient) Create(ctx context.Context, in *CreateOrderReq, opts ...grpc.CallOption) (*Order, error) {
...
type OrderServiceServer interface {
	Create(context.Context, *CreateOrderReq) (*Order, error)
...
func (UnimplementedOrderServiceServer) Create(context.Context, *CreateOrderReq) (*Order, error) {
...
var OrderService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "ordersPB.OrderService",
